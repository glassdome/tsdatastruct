 ...
 */
export const randomFloat = (min: number, max: number, decimalPlaces: number = 2): number => {
 ...
 */
export const randomFloatSeq = (min: number, max: number, size: number, decimalPlaces: number = 2): number[] => {
 ...
 */
export const randomNumber = (min: number, max: number, decimalPlaces: number = 2): number => {
 ...
 */
export const randomNumberSeq = (min: number, max: number, size: number, decimalPlaces: number = 2): number[] => {
...
export const randomIntSeq = (min: number, max: number, size: number): number[] => {
  return[...Array(size)].map(_ => { return randomInt(min, max) })
}
